...
fit3_q1_wide <-
  brm(data = beh2,
      ...
      file = ".\\brms_fits\\fit3_q1_wide.rds")
...
fit3_q2_wide <-
  brm(data = beh2,
      ...
      file = ".\\brms_fits\\fit3_q2_wide.rds")
...
fit3_q3_wide <-
  brm(data = beh2,
      ...
      prior = priors, save_pars = save_pars(all = TRUE),
      seed = 42, warmup = 1000, iter = 12000, cores = 4, chains = 4, control = list(adapt_delta = .95),
      file = ".\\brms_fits\\fit3_q3_wide.rds")
...
fit3_q4_wide <-
  brm(data = beh2,
      ...
      prior = priors, save_pars = save_pars(all = TRUE),
      seed = 42, warmup = 1000, iter = 12000, cores = 4, chains = 4, control = list(adapt_delta = .95),
      file = ".\\brms_fits\\fit3_q4_wide.rds")
...
fit3_q5_wide <-
  brm(data = beh2,
      ...
      prior = priors, save_pars = save_pars(all = TRUE),
      seed = 42, warmup = 1000, iter = 12000, cores = 4, chains = 4, control = list(adapt_delta = .95),
      file = ".\\brms_fits\\fit3_q5_wide.rds")
...
fit3_q6_wide <-
  brm(data = beh2,
      ...
      prior = priors, save_pars = save_pars(all = TRUE),
      seed = 42, warmup = 1000, iter = 12000, cores = 4, chains = 4, control = list(adapt_delta = .95),
      file = ".\\brms_fits\\fit3_q6_wide.rds")

bfp_q1_wide <- bayestestR::bayesfactor_parameters(fit3_q1_wide, null = 0)
bfp_q2_wide <- bayestestR::bayesfactor_parameters(fit3_q2_wide, null = 0)
bfp_q3_wide <- bayestestR::bayesfactor_parameters(fit3_q3_wide, null = 0)
bfp_q4_wide <- bayestestR::bayesfactor_parameters(fit3_q4_wide, null = 0)
bfp_q5_wide <- bayestestR::bayesfactor_parameters(fit3_q5_wide, null = 0)
bfp_q6_wide <- bayestestR::bayesfactor_parameters(fit3_q6_wide, null = 0)

bfps <- ls()[str_detect(ls(), "bfp")]
bfps <- c("bfp_q1_wide", "bfp_q2_wide", "bfp_q3_wide", "bfp_q4_wide", "bfp_q5_wide", "bfp_q6_wide")
...
loo3_q1_wide <- loo(fit3_q1_wide, moment_match = T)
loo3_q2_wide <- loo(fit3_q2_wide, moment_match = T)
loo3_q3_wide <- loo(fit3_q3_wide, moment_match = T)
loo3_q4_wide <- loo(fit3_q4_wide, moment_match = T)
loo3_q5_wide <- loo(fit3_q5_wide, moment_match = T, reloo = T)
loo3_q6_wide <- loo(fit3_q6_wide, moment_match = T)

loos <- c("loo3_q1_wide", "loo3_q2_wide", "loo3_q3_wide", "loo3_q4_wide", "loo3_q5_wide", "loo3_q6_wide")
